<template>
  <div>
    ...
    <div v-if="completedList.length" class="show_com_todo" @click="() => (showCompletedTodo = !showCompletedTodo)">
...
// 重置当前任务数据
function resetTodo() {
  localTodo.value = { id: null, text: "", priority: NOT_URGENT_NOT_IMPORTANT, estimatedPomodoros: 0 };
}
